        ...
        <div class="col-md-4">
          <div class="row">
            ...
            <div class="col-6">
              ...
              <ul class="list-unstyled">
                <li class="mb-2">
                  <router-link to="/transparencia" class="text-white text-decoration-none">
                    <i class="fas fa-shield-alt me-2"></i>Transparencia
                  </router-link>
                </li>
                <li class="mb-2">
                  <router-link to="/documentos" class="text-white text-decoration-none">
                    <i class="fas fa-archive me-2"></i>Documentos
                  </router-link>
                </li>
                <li class="mb-2">
                  <router-link to="/humano" class="text-white text-decoration-none">
            ...
            <div class="col-6">
              ...
              <ul class="list-unstyled">
                <li class="mb-2">
                  <router-link to="/proteccion-datos" class="text-white text-decoration-none">
                    <i class="fas fa-user-shield me-2"></i>Protección de datos
                  </router-link>
                </li>
                <li class="mb-2">
                  <router-link to="/terminos" class="text-white text-decoration-none">
                    <i class="fas fa-balance-scale me-2"></i>Términos y condiciones
                  </router-link>
                </li>
                <li class="mb-2">
                  <router-link to="/mapa-sitio" class="text-white text-decoration-none">
