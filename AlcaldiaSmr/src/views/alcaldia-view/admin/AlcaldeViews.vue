...
<template>
  <div class="container mt-4">
              ...
              <tr v-for="alcalde in filteredAlcaldes" :key="alcalde.id">
                ...
                <td>
                  <span
                    :class="[
                      'status-badge',
                      alcalde.actual ? 'bg-primary' : 'bg-primary',
                    ]"
                  >
                    {{
                      alcalde.actual
                ...
                <td>
                  <div class="btn-group btn-group-sm">
                    ...
                    <button
                      @click="openEditModal(alcalde)"
                      class="btn btn-outline-primary"
                    >
                      <i class="fas fa-edit"></i>
                    </button>
                    <button
                      @click="confirmDelete(alcalde.id)"
                      class="btn btn-outline-primary"
                    >
    ...
    <AlcaldeViewModal v-model:show="showViewModal" :alcalde="currentAlcalde" />
...
import AlcaldeFormModal from "@/components/alcaldia/admin/AlcaldeFormModal.vue";
import AlcaldeViewModal from "@/components/alcaldia/admin/AlcaldeViewModal.vue";
