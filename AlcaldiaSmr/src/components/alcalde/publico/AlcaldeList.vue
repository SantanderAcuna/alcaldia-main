      ...
      <div class="alcalde-header">
        ...
        <div class="alcalde-info">
          ...
          <div class="alcalde-status">
            <span :class="['status-badge', alcalde?.actual ? 'active' : 'inactive']">
      ...
      <div class="detail-section">
        ...
        <div class="detail-grid">
          <div class="detail-item">
            ...
            <span class="detail-value">{{ alcalde?.fecha_inicio || '—' }}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label">Fecha de fin</span>
            <span class="detail-value">{{ alcalde?.fecha_fin || '—' }}</span>
          </div>
        </div>
      </div>
      ...
      <div v-if="alcalde?.plan_desarrollo" class="detail-section">
        ...
        <div class="detail-grid">
          <div class="detail-item">
            ...
            <span class="detail-value">{{ alcalde.plan_desarrollo.titulo || '—' }}</span>
          </div>
          <div class="detail-item full-width">
            <span class="detail-label">Descripción</span>
            <span class="detail-value">{{ alcalde.plan_desarrollo.descripcion || '—' }}</span>
          </div>
          <div v-if="documentoUrl" class="detail-item full-width">
            <span class="detail-label">Plan de Desarrollo</span>
